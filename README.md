# le: means simp`Le`
##### Adding AWS Route53 support to the fork of the great job of: [NeilPang/le](https://github.com/Neilpang/le) and [mbentley/dns-r53.sh](https://gist.github.com/mbentley/d5da0bf962f050dd07ec)
...
It includes dns challenge support for AWS:
 - AWS Route53 (multi domain registration in a single certificate) [+info](dnsapi)
 - Cloudflare.com
 - Dnspod.cn
 - Cloudxns.com api
